...
**Not exposed:** the rest of the mutating surface. 48 of the 151 commands take
...
and is a v2 change — [ADR 0010](docs/adr/0010-secrets-move-out-of-env-not-off-the-disk.md)
...
[ADR 0009](docs/adr/0009-a-policy-file-is-not-a-lock.md).
